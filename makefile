...
import/websites/gr.maharashtra.gov.in/WaterSanitation:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/WaterSanitation .
...
import: check_env import/websites/gr.maharashtra.gov.in/WaterSanitation .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/WaterSanitation import/documents
