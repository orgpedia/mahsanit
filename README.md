# Orders of deparment of Water Supply and Sanitation Department Government of Maharashtra

This is a data package repository that process orders obtained from department of Water Supply and Sanitation Department Government of Maharasthra. The data is obtained by processing orders from Government of Maharashtra's [Orders Website](https://gr.maharashtra.gov.in/1145/Government-Resolutions) website.
...
1. [mahsanit-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahsanit-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
## Data Details
- **First Order:** [201803121414108428.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/201803121414108428.pdf) (13 March 2018)
- **Last Order:** [202309221429168728.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/202309221429168728.pdf) (22 September 2023)
- **Last Crawl Date:** 23-Sep-2023
- **Total Orders:** 3140
- **Translated Orders:** 3108
...
```
git clone https://github.com/orgpedia/mahsanit.git
```
